...
To avoid this, you can use https://graphfoundation.github.io/ongdb-apoc/#_nodes_collapse[APOC Nodes collapse]. `apoc.nodes.collapse` merges the set of nodes into a virtual node.
...
You can find more information about the parameter configuration of `apoc.nodes.collapse` on https://graphfoundation.github.io/ongdb-apoc/#_nodes_collapse[APOC Nodes collapse].
...
Notice that the British Library service requires you to encode the SPARQL query. We do this with https://graphfoundation.github.io/ongdb-apoc/#_overview_text_functions[APOC's apoc.text.urlencode function]. After running this you get a pretty poor graph, because the
